"use client";
import { AlignJustify, MapPinIcon, X } from "lucide-react";
import { Badge } from "../ui/badge";
import { useEffect, useRef, useState } from "react";
import SideMenu from "./side-menu";

const navmenu = ["menu", "rewards", "gift cards"];
...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex justify-between lg:justify-normal items-center container">
        ...
        <div className="hidden lg:flex justify-between items-center py-10 w-[90%]">
          <div className="flex justify-between gap-6 items-center font-semibold text-[#2C2D2D]">
            {navmenu.map((nav) => (
              <span key={nav}>{nav.toUpperCase()}</span>
            ))}
          </div>
      ...
      >
        <SideMenu navmenu={navmenu} isMenuOpen={isMenuOpen} />
      </div>
    </>
  );
};
